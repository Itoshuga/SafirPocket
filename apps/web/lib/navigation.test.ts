...
describe('administration navigation permissions', () => {
  ...
  it('declares the complete administration group in one ordered configuration', () => {
    ...
    expect(
      ...
      { label: 'Boosters', href: '/admin/boosters', permission: 'BOOSTERS_READ_ADMIN' },
...
describe('administration route matching', () => {
  it.each([
    ...
    ['/admin/boosters/new', 'admin-boosters'],
    ['/admin/boosters/77777777-7777-4777-8777-777777777777', 'admin-boosters'],
